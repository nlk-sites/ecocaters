...
*/  
  if ($sError == '') {
	...
	wp_mail('leads@ecocaters.com, adam@ecocaters.com, nicole@ecocaters.com, emily@ecocaters.com, john@ecocaters.com', $fldcontact_name.' contact us request', $message);
	$sSuccess = 1;
  }
  else {
...
?>	
				<div class="c3">
                    ...
                    <div class="cloc">
                        ...
                        <p>202.810.3262</p>
                        <div class="gmap"><a href="https://goo.gl/maps/rEXoc" target="_blank" title="Get Directions"><img src="http://maps.googleapis.com/maps/api/staticmap?center=627+N+Glebe+Rd,+Arlington,+Virginia+22203&zoom=10&size=210x113&maptype=roadmap&markers=color:green%7Clabel:E%7C38.8786679,-77.1094206&sensor=false" width="210" height="113" alt="google map" /></a></div>
                    </div>
                </div>
				<?php endwhile; endif; ?>
