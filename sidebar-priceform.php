...
<input type="text" class="textInp" id="lf_name" name="lf_name" value="name (first and last)" onfocus="if(this.value=='name (first and last)')this.value=''" onblur="if(this.value=='')this.value='name (first and last)'" />
